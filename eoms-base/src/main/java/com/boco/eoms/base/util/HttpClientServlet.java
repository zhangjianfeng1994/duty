...
public class HttpClientServlet {
    ...
    public static HttpResponse httpPutRaw(String url,String stringJson,Map<String,String> headers, String encode){  
        ...
        try {  
            ...
            LogOutTool.info(HttpClientServlet.class,"http put requert result = " + content);
        } catch (Exception e) {  
            e.printStackTrace();  
        }finally{  
            try {  
...
//                            + entity.getContentLength());  
     ...
     * @return
     */
    public static JSONObject httpPostRaw(String url,String stringJson,Map<String,String> headers, String encode){
    	if(encode == null){  
            encode = "utf-8";  
        }
        //HttpClients.createDefault()等价于 HttpClientBuilder.create().build();   
        ...
        try {
            ...
            HttpEntity entity = httpResponse.getEntity();  
            content = EntityUtils.toString(entity, encode);  
            LogOutTool.info(HttpClientServlet.class,"http post requert result = " + content);
        } catch (Exception e) {  
            e.printStackTrace();  
        }finally{  
            try {  
