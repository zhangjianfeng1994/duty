...
public class ClassLoaderUtil {
    ...
    public static String getAbsolutePathOfClassLoaderClassPath() {
        ...
        LogOutTool.info(ClassLoaderUtil.class,ClassLoaderUtil.getClassLoader().getResource(
                "").toString());
    ...
    public static URL getExtendResource(String relativePath)
        ...
        LogOutTool.info(ClassLoaderUtil.class,"relativePath=="+new Integer(relativePath.lastIndexOf("../")));
        ...
        LogOutTool.info(ClassLoaderUtil.class,"绝对路径：" + resourceAbsolutePath);
    ...
    public static URL getResource(String resource) {
    	LogOutTool.info(ClassLoaderUtil.class,"传入的相对于classpath的路径：" + resource);
